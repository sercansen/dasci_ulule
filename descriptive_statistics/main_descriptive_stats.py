...
from descriptive_statistics.nb_rewards import show_stats as rewards_show_stats
...
def show_stats(data: DataFrame, data_pre_covid: DataFrame, data_post_covid: DataFrame, data_general: DataFrame, are_stats_cat: bool) -> str:
    ...
    print("--- Fin des stats descriptives sur la colonne amount_raised")
    string_to_print += analytics_count_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne analytics_count")
    string_to_print += background_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne background")
    string_to_print += comments_count_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne comments")
    string_to_print += fans_count_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne fans_count")
    string_to_print += goal_raised_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne goal_raised")
    string_to_print += goal_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne goal")
    string_to_print += main_tag_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne main_tag")
    string_to_print += nb_days_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne nb_days")
    string_to_print += news_count_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne news_count")
    string_to_print += percent_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne percent")
    string_to_print += post_covid_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne post_covid")
    string_to_print += rewards_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne nb_rewards")
    string_to_print += sponsorships_count_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne sponsorships")
    string_to_print += supporters_count_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne supporters")
    string_to_print += video_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne video")
    string_to_print += visible_show_stats(data)
    print("--- Fin des stats descriptives sur la colonne visible")
